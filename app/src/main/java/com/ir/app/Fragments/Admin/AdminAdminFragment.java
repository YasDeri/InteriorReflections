...
import com.ir.app.Adapters.Admin.AdminAdapter;
...
//        }
        View v = inflater.inflate(R.layout.fragment_admin_admin, container, false);
        recyclerView = v.findViewById(R.id.admin_rv);
...
//        }
        ...
        adapter = new AdminAdapter(UserHelper.getInstance().getUsers("Admin"), getActivity());
